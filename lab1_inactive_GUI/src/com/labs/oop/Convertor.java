...
import static com.labs.oop.Main.indexOf;
...
public class Convertor {
    ...
    public void convert(String filen) throws IOException {
        try {
...
//            File audit_file = new File(filen);
        ...
        BufferedWriter fileWriter = new BufferedWriter(new FileWriter("\\sample.txt"));
        fileWriter.write("{\n");
